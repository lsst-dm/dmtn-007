...
.. code-block:: bash
   ...
   git clone https://github.com/lsst-dm/dmtn-007
   cd dmtn-007
...
The published technote at http://dmtn-007.lsst.io will be automatically rebuilt whenever you push your changes to the ``master`` branch on `GitHub <https://github.com/lsst-dm/dmtn-007>`_.
